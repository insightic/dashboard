    ...
    <div class="mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6 my-2">
                <ChartComponent type="bar" title="Daily Frequency" :labels="[
            ...
            <div class="col-md-6 my-2">
                <ChartComponent type="bar" title="Hourly Frequency" :labels="[
            ...
            <div class="col-md-6 my-2">
                <ChartComponent title="Daily Bought/Sold Volume" :labels="[
                            ...
                            ]" :data="[
                                {
                                    ...
                                    data: data?.stablecoin?.transaction?.daily_bought_vol.data.map((d: any) => Number(d[1]))
                                },
                                {
          ...
          :data="[
            {
              ...
              data: data?.stablecoin?.transaction?.hourly_bought_vol.data.map((d: any) => Number(d[1]))
            },
            {
              name: 'Hourly Sold Volume',
              data: data?.stablecoin?.transaction?.hourly_sold_vol.data.map((d: any) => Number(d[1]))
            }
          ]"
        />
            </div>
